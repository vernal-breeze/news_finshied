  ...
  return (
    <div style={{ padding: '24px 32px' }}>
          ...
          <Col span={6} style={{ textAlign: 'center' }}>
            <div style={{ position: 'relative', display: 'inline-block' }}>
              {profile.avatar ? (
                ...
                <Avatar size={100} icon={<UserOutlined />} style={{ backgroundColor: '#722ed1' }} />
              )}
              <Upload
              ...
              >
                <Button
                  ...
                  style={{
                    ...
                    backgroundColor: '#722ed1', color: '#fff', border: 'none'
                  }}
                />
              </Upload>
            </div>
            ...
            <div style={{ marginTop: 8 }}>
              <span style={{
                ...
                backgroundColor: '#f9f0ff', color: '#722ed1', fontSize: 12
              }}>
      ...
      <Card style={{ marginBottom: 24 }} styles={{ body: { padding: 24 } }}>
        <Row gutter={24}>
          <Col span={6}>
            <Statistic title="总稿件" value={profile.article_count} prefix={<FileTextOutlined style={{ color: '#52c41a' }} />} />
          </Col>
          <Col span={6}>
            <Statistic title="已发布" value={profile.published_count} prefix={<FileTextOutlined style={{ color: '#3f8600' }} />} />
          </Col>
          <Col span={6}>
            <Statistic title="待审核" value={profile.pending_review_count} prefix={<CheckCircleOutlined style={{ color: '#faad14' }} />} />
          </Col>
          <Col span={6}>
            <Statistic title="线索统计" value={profile.clue_count} prefix={<BulbOutlined style={{ color: '#1890ff' }} />} />
          </Col>
        </Row>
      </Card>
      ...
      >
        <Form form={form} layout="vertical" style={{ marginTop: 16 }}>
          <Form.Item name="nickname" label="昵称" rules={[{ max: 20 }]}>
          ...
          <Form.Item name="full_name" label="姓名" rules={[{ max: 50 }]}>
